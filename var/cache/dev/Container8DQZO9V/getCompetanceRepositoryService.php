 ...
 */
class getCompetanceRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CompetanceRepository' shared autowired service.
     *
     * @return \App\Repository\CompetanceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CompetanceRepository.php';

        return $container->privates['App\\Repository\\CompetanceRepository'] = new \App\Repository\CompetanceRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
