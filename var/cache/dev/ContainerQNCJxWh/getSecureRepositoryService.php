 ...
 */
class getSecureRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SecureRepository' shared autowired service.
     *
     * @return \App\Repository\SecureRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SecureRepository.php';

        return $container->privates['App\\Repository\\SecureRepository'] = new \App\Repository\SecureRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
