...
class __TwigTemplate_69ffa013850b7ac016715d300c67d51cc117159ee91081a4b5b0130f57f55028 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["etat"]) {
            ...
            yield "</td>
                <td>";
            // line 21
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["etat"], "nomEtat", [], "any", false, false, false, 21), "html", null, true);
            yield "</td>
                <td>";
            // line 22
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["etat"], "typeEtat", [], "any", false, false, false, 22), "html", null, true);
            yield "</td>
                <td>
                    <a href=\"";
            // line 24
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_etat_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["etat"], "id", [], "any", false, false, false, 24)]), "html", null, true);
            yield "\">show</a>
                    <a href=\"";
            // line 25
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_etat_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["etat"], "id", [], "any", false, false, false, 25)]), "html", null, true);
            yield "\">edit</a>
                </td>
            </tr>
        ";
    ...
    <table class=\"table\">
        ...
        {% for etat in etats %}
            <tr>
                ...
                <td>{{ etat.typeEtat }}</td>
                <td>
                    <a href=\"{{ path('app_etat_show', {'id': etat.id}) }}\">show</a>
