...
class Client extends \App\Entity\Client implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'nom_client', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'prenom_client', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'adresse', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'telephone', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'projets', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'notifications'];
        }
